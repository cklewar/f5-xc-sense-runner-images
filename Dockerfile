...
RUN curl -k -L https://github.com/fortio/fortio/releases/download/v${FORTIO_VERSION}/fortio_${FORTIO_VERSION}_amd64.deb --output /tmp/fortio_${FORTIO_VERSION}_amd64.deb
